...
- Prefer vertical slices that deliver a narrow complete behavior end-to-end over horizontal layer-only work.
- Mark work AFK, HITL, or Human when planning delegation.
